...
int main(int argc, char * argv[]){
    ...
    int value = atoi(argv[2]); // Changement char à int
    ...
    switch(value){
        case 1: // option -t
            ...
            // Sortie des données dans le tableau de structure 'top10'
        ...
        case 2: // option -s
            ...
            while (fgets(ligneS, sizeof(ligneS), fichierSource)){
                ...
                // Attribution des données du fichier 'data.csv'
            ...
            // Sortie des données dans le tableau de structure 'top50'
